...
{
    public partial class RewardsForm : BaseForm
    {
        ...
        public async void init()
        {
            ...
            AddRewards(await RestApi.RewardService.GetAll(false));
        ...
        private void dataGridView_rewards_CellClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void RewardsForm_Shown(object sender, EventArgs e)
        {
            dataGridView_rewards.ClearSelection();
        }
    }
}